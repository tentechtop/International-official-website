<template>
  <div>
    ...
    >
      <img src="https://file.kwunphi.com/kwunphi4/images/customService/kwun-baby.png">
    </a>
    ...
    <div v-if="!isShowChatWindows" class="card-container" :class="{hoverCard:isMouseOver}"
      ...
      <div class="card">
        <div class="card-item call-phone">
          <img src="https://file.kwunphi.com/kwunphi4/images/customService/24gf-phoneLoudspeaker.svg">
          <div class="phone-number">
            <p>{{ $t('customer.serviceHotline') }}</p>
            <h1>{{locale.startsWith("zh")? '':'+86 '}} 4008786861</h1>
          </div>

        </div>
        <div class="card-line"></div>
        <div class="card-item contact">
          <img src="https://file.kwunphi.com/kwunphi4/images/customService/message.svg">
          <p>{{ $t('customer.communicateOnline') }}:</p>
          <a :href="getRandomChatCustomer()" target="_blank"  class="contact-button">
            {{ $t('customer.enquireNow') }}
          </a>
        </div>
        <div class="card-line"></div>
        ...
        >
          <div> {{ $t('customer.onlineMessage') }}</div>
          <img src="https://file.kwunphi.com/kwunphi4/images/customService/right-arrow.svg">
        </div>
      </div>
    ...
    <div  class="chat-windows" :class="{'show-chat-windows':isShowChatWindows}">
      <div class="windows-header">
        <div class="chat-logo-container">
          <img src="https://file.kwunphi.com/kwunphi4/images/customService/20231019165013.png">
          <div class="welcome">
            <h1>{{ $t('customer.hi') }}</h1>
            <p>{{ $t('customer.pleasureServe') }}，{{ $t('customer.serviceHotline') }}：4008786861</p>
          </div>
        </div>
      ...
      <div class="chat-message-container" ref="chatListDom">
        <div class="message-item" v-for="item of filteredList">
          <div class="user-message-content" v-if="item.role === 'user'" :class="item.role === 'user'? 'user-message':'service-message'">
            ...
            <img src="https://file.kwunphi.com/kwunphi4/images/customService/cust2.png">
          </div>
          <div class="user-message-content" v-if="item.role !== 'user'" :class="item.role === 'user'? 'user-message':'service-message'">
            <img src="https://file.kwunphi.com/kwunphi4/images/customService/ServiceLogo.png">
      ...
      <div class="message-send-container">
        <div class="service-level-container">
          <div class="human-service">
            <img src="https://file.kwunphi.com/kwunphi4/images/email/human-service.svg">
            <a :href="getRandomChatCustomer()" target="_blank" >转人工</a>
          </div>
        </div>
        <div class="message-container">
          <textarea class="message-input" :placeholder="$t('customer.pleaseEnterQuestion')"
                    v-model="messageContent"
                    @keydown.enter="isTalking || sendOrSave()"></textarea>
        </div>
