<template>
  <div class="video-container"  :style="{ 'background-image': 'url(' + poster + ')', 'background-size': 'cover' ,'background-position': 'center'}">
...
<!--             @mouseover="togglePlayVideo"
    ...
    <kw-image v-show="!isPlaying"
              :src="imgUrl"
              class="video-poster-wrapper animate__animated animate__fadeIn animate__zoomIn"
              style="z-index: 2"></kw-image>
